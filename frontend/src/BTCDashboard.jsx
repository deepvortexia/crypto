...
import { fetchMarketTensions, getProSession } from './api/client'
import {
  fetchSentiment,
  fetchNewsSentiment,
  fetchPrediction,
...
const [deepOpen,      setDeepOpen]      = useState(false)
  ...
  async function runDeepAnalysis(horizon) {
    ...
    const L = [
      'Connecting...',
      'BTC: $'+(price?.price?.toLocaleString() ?? 'N/A'),
      'RSI '+(indics?.rsi ?? 'N/A'),
      'MACD: '+(indics?.macd?.histogram != null ? (indics.macd.histogram > 0 ? 'Bullish' : 'Bearish') : 'N/A'),
      'Fear: '+(sentiment?.value ?? 'N/A'),
      'EMA: '+(indics?.ema50 != null && indics?.ema200 != null ? (indics.ema50 > indics.ema200 ? 'Golden Cross' : 'Death Cross') : 'N/A'),
      ...
      'OI Change: '+(liquidations?.change ?? 'N/A')+'%',
      'Market Tensions: '+(tensions?.length ? tensions[0].type+' signal detected' : 'scanning…'),
      'Bollinger squeeze: '+(indics?.bollinger_bands?.bandwidth != null ? (indics.bollinger_bands.bandwidth < 0.05 ? 'Detected ⚠️' : 'Not detected') : 'N/A'),
          ...
          <div className="mobile-dropdown" style={{position:'absolute',top:'var(--header-h)',left:0,right:0,background:'rgba(10,10,10,0.97)',borderBottom:`1px solid #2a1f00`,zIndex:999,padding:'0'}}>
            ...
            {authLoading ? null : user ? (
              <div style={{padding:'8px 20px 16px',borderBottom:`1px solid #2a1f00`,marginBottom:8}}>
                ...
                <button onClick={() => { setBuyCreditsOpen(true); setMenuOpen(false) }} style={{width:'100%',fontFamily:'"Share Tech Mono",monospace',fontSize:11,letterSpacing:'0.15em',color:G.gold,background:'none',border:`1px solid ${G.gold}44`,borderRadius:6,padding:'11px 16px',cursor:'pointer',textTransform:'uppercase',minHeight:44,marginBottom:10}}>+ BUY CREDITS</button>
        ...
        <div style={{textAlign:'center',padding:'16px 0'}}>
          {(() => {
            ...
            return (
              ...
              >
                  <img src="/logoegyptfinal.webp" alt="" width="22" height="22" loading="lazy" style={{ height: 22, width: 'auto', objectFit: 'contain', opacity: outOfCredits ? 0.4 : 1 }} />
                  DEEP ANALYSIS
                </button>
      ...
      <main className="main-pad" style={{ maxWidth: 1400, margin: '0 auto', padding: '32px 32px' }}>
              ...
              <div key={k} style={{ position: 'relative' }}>
                ...
                {!isPro && (
                  <div onClick={() => setPricingOpen(true)} style={{
                    ...
                    <img src="/logoegyptfinal.webp" alt="" width="40" height="40" loading="lazy" style={{ width: 40, height: 40, objectFit: 'contain' }} />
        ...
        <div className="site-footer" style={{ borderTop: `1px solid ${G.border}`, paddingTop: 28, paddingBottom: 20, marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, textAlign: 'center' }}>
          ...
          <a href="https://x.com/PredictAlphapp" target="_blank" rel="noopener noreferrer" style={{display:'inline-flex', alignItems:'center', gap:6, textDecoration:'none', opacity:0.75}}>
            <svg viewBox="0 0 24 24" width="20" height="20" fill="#f59e0b" aria-hidden="true">
            ...
            <span style={{fontFamily:'"Share Tech Mono",monospace', fontSize:11, color:'#f59e0b', letterSpacing:'0.1em'}}>X / Twitter</span>
          </a>
        </div>
      </main>
        ...
        <div style={{ position:'fixed', inset:0, zIndex:300, background:'rgba(0,0,0,0.92)', display:'flex', alignItems:'center', justifyContent:'center', backdropFilter:'blur(8px)', overflowY:'auto', WebkitOverflowScrolling:'touch', padding:'16px' }}>
          {authSuccess ? (
            ...
            <div style={{
              ...
              <img src="/logoegyptfinal.webp" alt="" width="80" height="80" loading="lazy" style={{ width:80, height:80, objectFit:'contain', marginBottom:24 }} />
          ...
          <div className="deep-modal-box" style={{
            ...
            <div className="deep-analysis-area" style={{ display:'flex', flex:1, minHeight:0, overflow:'hidden' }}>
              ...
              <div className="deep-right-col" style={{
                ...
                {deepRunning && (<>
                  <img src="/egyptian-dial.webp" alt="" className="deep-dial-img" loading="lazy" style={{ width:260, height:260, objectFit:'contain', display:'block', opacity:0.78, animation:'dialGlow 2s ease-in-out infinite' }} />
        ...
        <div style={{
          ...
          <div onClick={e => e.stopPropagation()} className="pricing-modal-box" style={{
            ...
            <div style={{ padding: '24px 28px', borderBottom: `1px solid ${G.border}`, textAlign: 'center' }}>
              <img src="/logoegyptfinal.webp" alt="Predict Alpha" width="80" height="80" loading="lazy" style={{ width: 80, height: 80, objectFit: 'contain', marginBottom: 8 }} />
